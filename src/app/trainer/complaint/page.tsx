...
const previousComplaints = [
  {
    ...
    description:
      "The cable machine in the weight room (machine #3) is not functioning properly. The cables are frayed and pose a safety risk.",
    date: "2023-11-15",
    status: "resolved",
    response:
      "Thank you for reporting this issue. Our maintenance team has replaced the cables and performed a full safety check on the machine.",
    responseDate: "2023-11-17",
  },
  {
    id: 2,
    subject: "Schedule Conflict",
    description: "There was a double booking for Studio 2 during my session with client John Smith on November 20th.",
    date: "2023-11-18",
    status: "in-progress",
    response: null,
    responseDate: null,
  ...
  {
    id: 3,
    subject: "Client Behavior",
    description:
      "I'm having issues with a client who consistently arrives late to sessions and disrupts other training sessions.",
    date: "2023-10-30",
    status: "resolved",
    response:
      "We've spoken with the client about the importance of punctuality and respecting other sessions. They have agreed to arrive 10 minutes early for future sessions.",
    responseDate: "2023-11-02",
  },
]

export default function TrainerComplaintPage() {
    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-1 text-gray-600">Report any issues or concerns you encounter as a trainer.</p>
        </div>
              ...
              {submitSuccess && (
                <div className="mb-6 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded flex items-start">
                  ...
                  <div>
                    ...
                    <p>Management will review your complaint and get back to you as soon as possible.</p>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="client">Client Behavior</option>
          ...
          <div>
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <ul className="space-y-3 text-sm text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-2">•</span>
                  <span>Maintain a professional tone in your complaint.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-2">•</span>
                  <span>If your complaint involves a client, please respect their privacy.</span>
                </li>
              </ul>
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-sm text-gray-600">Need immediate assistance? Contact management directly:</p>
                <p className="mt-2 text-sm font-medium">Phone: (555) 123-4567</p>
                <p className="text-sm font-medium">Email: management@fithub.com</p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-blue-900">Need to discuss in person?</h3>
                  <p className="mt-1 text-sm text-blue-700">
                    Schedule a meeting with the gym manager to discuss your concerns.
                  </p>
                  <Link
                    href="/contact"
